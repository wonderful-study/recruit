                ...
                <div class="col-md-9 col-sm-9">
                    <section id="agent-detail">
                        ...
                        <section id="agent-info">
                            <div class="row">
                                <div class="col-md-3 col-sm-3">
                                    <figure class="agent-image"><img alt="" src="${(agency.avatar)!}"></figure>
                                </div><!-- /.col-md-3 -->
                                <div class="col-md-5 col-sm-5">
                                    ...
                                    <dl>
                                        ...
                                        <dt>网址:</dt>
                                        <dd><a href="mailto:#">${(agency.webSite)!}</a></dd>
                                        <dt>地址:</dt>
                                        <dd><a href="mailto:#">${(agency.address)!}</a></dd>
                                    <#--<dt>经纪机构:</dt>
                        ...
                        <section id="agent-properties">
                            <header><h3>公司人事</h3></header>
                            <div class="layout-expandable">
                                <div class="row">
                                  <#list bindUsers as user>
                                      <div class="col-md-4 col-sm-4">
                                          <div class="property">
                                              <a href="/agency/agentDetail?id=${(user.id)!}">
                                                  <div class="property-image">
                                                      <img alt="" src="${user.avatar}" height="292.5px">
                                                  </div>
                                                  <div class="overlay">
                                                      <div class="info">
                                                          <h3>${(user.name)!}</h3>
